                ...
                <div class="flip-box">\
                    <div class="flip-box-inner">\
                            <div class="flip-box-front">\
                                <h2>'+ param.products[i].category.name +'</h2><br>\
                                <p>'+param.products[i].sku+'</p><br>\
                                <p>'+param.products[i].name+'</p><br>\
                                <p>'+param.products[i].price+'</p><br><br>\
                                <p>'+param.products[i].category.name+'</p>\
                            </div>\
                            <div class="flip-box-back">\
                                <h2>Beschreibung</h2>\
                                <p>'+param.products[i].description+'</p>\
                                <img src="'+param.products[i].image+'" alt="" wide="50%" height="50%">\
                            </div>\
                    </div>\
                </div>\
           </div>';
